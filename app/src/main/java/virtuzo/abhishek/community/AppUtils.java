...
public class AppUtils {
    ...
    public void setCircularsResponse(String value) {
        setStringData("circularsresponce", value);
    }

    public String getCircularsResponse() {
        return getStringData("circularsresponce");
    }

    public void setEventsResponse(String value) {
        setStringData("eventsresponce", value);
    }

    public String getEventsResponse() {
        return getStringData("eventsresponce");
    }

    public void setBranchesResponse(String value) {
        setStringData("branchesresponce", value);
    }

    public String getBranchesResponse() {
        return getStringData("branchesresponce");
    }

    public Boolean isSynced() {
        return getBoolData("synced");
    }

    public void setSynced(Boolean value) {
        setBoolData("synced", value);
    }

    public void setAccessCode(String value) {
        setStringData("accessCode", value);
    }

    public String getAccessCode() {
        return getStringData("accessCode");
    }

    public void setEmergencyMessage(String value) {
        setStringData("emergencyMessage", value);
    }

    public String getEmergencyMessage() {
        return getStringData("emergencyMessage");
    }

    public void setComplaints(String value) {
        setStringData("complaints", value);
    }

    public String getComplaints() {
        return getStringData("complaints");
    }
