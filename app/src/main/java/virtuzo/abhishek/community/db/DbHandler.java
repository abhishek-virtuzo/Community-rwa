...
package virtuzo.abhishek.community.db;
...
public class DbHandler extends SQLiteOpenHelper {
    ...
    public List<PostItem> getGulak(String id) {
        ...
        String whereClause = "";
        mSql = "SELECT id, name, imageUrl,postUrl, description, liked, imageList, tagList,tagJSONArray,totalLike,totalComment,timestamp,type FROM '" + tbl_MST_Gulak + "'";
        if (id != null) {
...
//            mSql = cityQuery + " UNION " + regionQuery + " UNION " + countryQuery + " UNION " + generalQuery + " ORDER BY timestamp";
        ...
        while (c.moveToNext()) {
            ...
            mItem.setPostType(Integer.parseInt(c.getString(12)));
            mList.add(mItem);
        }
        c.close();
        db.close();
